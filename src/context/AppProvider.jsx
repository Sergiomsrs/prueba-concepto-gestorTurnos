...
export const AppProvider = ({children})=> {
    ...
    const [holidayDates , setHolidayDates ] = useState(["2024-01-01", "2024-01-06", "2024-04-19", "2024-05-01", "2024-06-06", "2024-08-15", "2024-10-12", "2024-11-01", "2024-12-06", "2024-12-08", "2024-12-25"]);
