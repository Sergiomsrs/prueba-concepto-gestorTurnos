...
export const AdminPage = () => {
  return (
    <div className="bg-gray-50 mb-20 pt-6">
      <div className="mx-auto max-w-2xl px-2 lg:max-w-7xl lg:px-8 mt-6">
        ...
        <div className="my-6 grid h-full gap-8 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
          ...
          <Link to="/simulator" className="relative group transition-transform hover:scale-105">
            <div className="absolute inset-px rounded-xl bg-white shadow-lg group-hover:shadow-2xl transition-shadow"></div>
            <div className="relative flex h-full flex-col overflow-hidden rounded-xl">
              <div className="flex-1 flex flex-col items-center justify-center p-10">
                <img
                  className="w-36 h-36 object-contain rounded-full border-4 border-indigo-100 shadow mb-6 bg-gray-100 transition-all duration-200 group-hover:scale-110"
                  src="admin-simulador.webp"
                  alt="Simulador de Rotación"
                />
                <h3 className="text-xl font-semibold text-indigo-700 mb-2 text-center">Simulador de escenarios</h3>
                <p className="text-base text-gray-600 text-center">
                  Simula la rotación de libranzas y turnos para optimizar la planificación de tu equipo.
                </p>
              </div>
            </div>
          </Link>
