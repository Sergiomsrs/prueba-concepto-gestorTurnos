  ...
  return (
    <nav className="bg-gray-900 border-b border-gray-800 shadow-sm relative z-50">
      <div className="mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center">
        ...
        {/* Bloque Central: Navegación (Solo si está autenticado) */}
        ...
        {/* Bloque Derecho: Usuario / Botón Hamburguesa Condicional */}
        <div className="w-1/3 flex justify-end items-center">
          <div className="hidden md:flex items-center gap-4">
            {auth.isAuthenticated ? (
              ...
              /* En login mostramos un enlace simple o nada si ya estás en /login */
          ...
          {/* LA HAMBURGUESA: Solo se renderiza si el usuario está logueado */}
          {auth.isAuthenticated && (
            <button
      ...
      {/* Menú móvil Condicional (Solo si está logueado y el menú está abierto) */}
