    ...
    <nav className="bg-gray-900 border-b border-gray-800 shadow-sm relative z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
        ...
        <div className="hidden md:flex items-center gap-6">
          <Link to="/report" className="text-lg text-gray-300 hover:text-indigo-400 transition font-semibold">Home</Link>
          <Link to="/" className="text-lg text-gray-300 hover:text-indigo-400 transition font-semibold">Create</Link>
          <Link to="/employeeweek" className="text-lg text-gray-300 hover:text-indigo-400 transition font-semibold">WbyE</Link>
        </div>
          ...
          {auth.isAuthenticated ? (
            <>
              ...
              <button
                ...
                className="flex items-center gap-2 text-base font-medium text-white bg-indigo-600 hover: bg-indigo-500 px-4 py-1.5 rounded transition"
              >
                Log out
            ...
            <Link
              to="/login"
              className="flex items-center gap-2 text-base font-medium text-white bg-indigo-500 hover: bg-indigo-500 px-4 py-1.5 rounded transition"
            >
              Log in
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="stroke-current">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
        ...
        <button
          ...
          className="md:hidden p-2 rounded text-indigo-400 hover:bg-gray-800 focus:outline-none"
