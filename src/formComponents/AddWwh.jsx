...
export const AddWwh = () => {
    ...
    const handleSave = (e) => {
        fetch('http://localhost:8081/api/wwh/add', {
            method: 'POST',
            headers: {
                ...
                <div className="border-b border-gray-900/10 pb-12">
                    ...
                    <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div className="sm:col-span-3">
                            ...
                            <div className="mt-2">
                                <input onChange={handleInputCreateChange} type="date" name="startDate" value={createForm.hireDate || ""}  className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                            </div>
                        </div>
                        <div className="sm:col-span-3">
                            <label htmlFor="last-name" className="block text-sm font-medium leading-6 text-gray-900">Termination Date</label>
                            <div className="mt-2">
                                <input onChange={handleInputCreateChange} type="date" name="endDate" value={createForm.terminationDate || ""}  className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                            </div>
                        </div>
